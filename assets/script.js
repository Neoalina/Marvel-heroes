let heroJSON =`[{
    ...
    },
    {
        ...
        "image":"assets/images/captainA.jpg",
        "universe":"Marvel Comics",
...
//     console.log(hero[1].heroName);  
// }
// document.getElementById('btnNext').onclick=() => {
//     let hero = JSON.parse(heroJSON);
//     for (let i=0; i<hero.length; i++) {
//         document.getElementById('heroName').innerHTML=hero[i].heroName;
//         document.querySelector('img').src=hero[i].image;
//         document.querySelector('.universe').innerHTML=hero[i].universe;
//         document.querySelector('.alter_ego').innerHTML=hero[i].alter_ego;
//         document.querySelector('.occupation').innerHTML=hero[i].occupation;
//         document.querySelector('.friends').innerHTML=hero[i].friends; 
//         document.querySelector('.power').innerHTML=hero[i].power;
//         document.querySelector('.detail').innerHTML=hero[i].detail;   
//     }
// }
